...
async function main() {
  ...
  const jsonPath = '/Users/garyireland/vite-react-template/instructions/prompt-v2.2.0-test-results-run2.json';
  ...
  const mdPath = '/Users/garyireland/vite-react-template/instructions/prompt-v2.2.0-test-results-run2.md';
